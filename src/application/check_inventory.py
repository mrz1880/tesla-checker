...
from src.domain.ports import InventoryGateway, NotificationSender, SnapshotRepository
from src.domain.vehicle import SearchCriteria
...
class CheckInventoryUseCase:
    ...
    def execute(self) -> CheckResult:
        ...
        for v in matching:
            log.info(f"  {v.title} ({v.year}) - {v.price:,} EUR - {v.odometer:,} km - {v.color_label} - {v.city}")
