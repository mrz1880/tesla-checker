...
class TestVehicleIdentity:
    def test_same_vin_are_equal(self) -> None:
        v1 = _make_vehicle(vin="ABC", price=30000)
        v2 = _make_vehicle(vin="ABC", price=40000)
        assert v1 == v2

    def test_different_vin_are_not_equal(self) -> None:
        v1 = _make_vehicle(vin="ABC")
        v2 = _make_vehicle(vin="DEF")
        assert v1 != v2

    def test_same_vin_same_hash(self) -> None:
        v1 = _make_vehicle(vin="ABC", price=30000)
        v2 = _make_vehicle(vin="ABC", price=40000)
